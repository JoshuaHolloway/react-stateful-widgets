...
export default function Spinner() {
  ...
  // STEP 4:
  //   -This click handler needs to toggle the spinner by setting 
  //    "whether on" to be the opposite of what it currently is.
  ...
  return (
    <div className='widget-spinner container'>
      <h2>Spinner</h2>
      {
        ...
        //    -If the expressions on both sides of the '&&' are truthy,
        //     the one on the right becomes the value of the whole line.
        //    -If an expression on either side of the '&&'
        //     is falsy, the one on the left becomes the value of the whole line.
        //    -It's a neat little trick to render a React element 
        //     (in this case the spinner) conditionally: 
        //      --only if the variable on the left is truthy.
      }
      <button id='toggleSpinner' onClick={toggleSpinner}>

        {/*
          STEP 3:
            -Use a ternary expression inside the text of the button, 
            to render "Hide" or "Show" depending on the value of 'spinnerOn'.
        */}
